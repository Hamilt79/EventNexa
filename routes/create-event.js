...
function reqToEvent(req) {
    ...
    let event = new Event(eventHeader['title'], eventHeader['description'], eventHeader['author'], eventHeader['eventCap'], eventHeader['eventDate'], eventMili, eventHeader['address']);
    return event;
}
